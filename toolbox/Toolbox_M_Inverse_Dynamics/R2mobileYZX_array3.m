...
%
% SYNOPSIS
% Joint_Euler_Angles = R2mobileYZX_array3(R)
%
% INPUT
...
% rotation matrix (R) using a sequence of mobile axes YZX
%
% REFERENCE
...
function Joint_Euler_Angles = R2mobileYZX_array3(R)

% Tetha1: Flexion-Extension (about Y proximal SCS axis)
Joint_Euler_Angles(1,1,:) = atan2(R(1,2,:),R(2,2,:));
 % Tetha2: Internal-External Rotation (about Z floating axis)
