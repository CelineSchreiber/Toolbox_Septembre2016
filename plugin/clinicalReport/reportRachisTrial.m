...
% Store data
Kinematics(1) = Condition(cond).Posturo(trial).Rangle;
Lkinematics(1) = Condition(cond).Posturo(trial).Langle;
...
if ~isempty(Kinematics(1).Hgr_tilt)
    plot(Kinematics(1).Hgr_tilt,'Linestyle','-','Linewidth',2,'Color',colorB(1,:));
end
axis tight; 
YL=ylim;
...
if ~isempty(Kinematics(1).Hgr_obli)
    plot(Kinematics(1).Hgr_obli,'Linestyle','-','Linewidth',2,'Color',colorB(1,:));
end
axis tight; YL=ylim;
YL=setAxisLim(YL,-10,10);
axis([0 100 YL(1) YL(2)]);
...
if ~isempty(Kinematics(1).Hgr_rota)
     plot(Kinematics(1).Hgr_rota,'Linestyle','-','Linewidth',2,'Color',colorB(1,:));
end
axis tight; YL=ylim;
YL=setAxisLim(YL,-10,10);
axis([0 100 YL(1) YL(2)]);
...
if ~isempty(Kinematics(1).Sgr_tilt)
     plot(Kinematics(1).Sgr_tilt,'Linestyle','-','Linewidth',2,'Color',colorB(1,:));
end
axis tight; YL=ylim;
YL=setAxisLim(YL,-10,10);
axis([0 100 YL(1) YL(2)]);
...
if ~isempty(Kinematics(1).Sgr_obli)
    plot(Kinematics(1).Sgr_obli,'Linestyle','-','Linewidth',2,'Color',colorB(1,:));
end
axis tight; YL=ylim;
YL=setAxisLim(YL,-10,10);
axis([0 100 YL(1) YL(2)]);
...
if ~isempty(Kinematics(1).Sgr_rota)
    plot(Kinematics(1).Sgr_rota,'Linestyle','-','Linewidth',2,'Color',colorB(1,:));
end
axis tight; YL=ylim;
YL=setAxisLim(YL,-10,10);
axis([0 100 YL(1) YL(2)]);
...
if ~isempty(Kinematics(1).Rgr_tilt)
    plot(Kinematics(1).Rgr_tilt,'Linestyle','-','Linewidth',2,'Color',colorB(1,:));
end
axis tight; YL=ylim;
YL=setAxisLim(YL,-10,10);
axis([0 100 YL(1) YL(2)]);
...
if ~isempty(Kinematics(1).Rgr_obli)
     plot(Kinematics(1).Rgr_obli,'Linestyle','-','Linewidth',2,'Color',colorB(1,:));
end
axis tight; YL=ylim;
YL=setAxisLim(YL,-10,10);
axis([0 100 YL(1) YL(2)]);
...
if ~isempty(Kinematics(1).Rgr_rota)
    plot(Kinematics(1).Rgr_rota,'Linestyle','-','Linewidth',2,'Color',colorB(1,:));
end
axis tight; YL=ylim;
YL=setAxisLim(YL,-10,10);
axis([0 100 YL(1) YL(2)]);
...
if ~isempty(Kinematics(1).Pgr_tilt)
    plot(Kinematics(1).Pgr_tilt,'Linestyle','-','Linewidth',2,'Color',colorB(1,:));
end
axis tight; YL=ylim;
YL=setAxisLim(YL,-10,10);
axis([0 100 YL(1) YL(2)]);
...
if ~isempty(Kinematics(1).Pgr_obli)
    plot(Kinematics(1).Pgr_obli,'Linestyle','-','Linewidth',2,'Color',colorB(1,:));
end
axis tight; YL=ylim;
YL=setAxisLim(YL,-10,10);
axis([0 100 YL(1) YL(2)]);
...
if ~isempty(Kinematics(1).Pgr_rota)
    plot(Kinematics(1).Pgr_rota,'Linestyle','-','Linewidth',2,'Color',colorB(1,:));
end
axis tight; YL=ylim;
YL=setAxisLim(YL,-10,10);
axis([0 100 YL(1) YL(2)]);
...
for g=1:length(Graph)
    ...
    plot([Event(1).p5 Event(1).p5],[-180 180],'Linestyle','-','Linewidth',2,'Color',colorB(1,:)); %IHS
    plot([Event(1).p2 Event(1).p2],[YL(1)-20 YL(1)+(YL(2)-YL(1))/10],'Linewidth',1.5,'Color',colorB(1,:)); %CTO
    plot([Event(1).p4 Event(1).p4],[YL(1)-20 YL(1)+(YL(2)-YL(1))/10],'Linewidth',1.5,'Color',colorB(1,:)); %CHS
end
