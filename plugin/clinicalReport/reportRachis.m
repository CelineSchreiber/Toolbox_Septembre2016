...
for i = 1:size(Condition,2)
    ...
    % Write the legend
    text(0.05,y/pageHeight,['Condition ',num2str(i)],'Color',colorR(i,:),'FontWeight','Bold');
...
for i = 1:size(Condition,2)
   if ~isempty(Kinematics(i).Hgr_tilt.mean)
        corridor(Kinematics(i).Hgr_tilt.mean,Kinematics(i).Hgr_tilt.std,colorR(i,:));
        plot(Kinematics(i).Hgr_tilt.mean,'Linestyle','-','Linewidth',2,'Color',colorR(i,:));
   end
end
axis tight; 
YL=ylim;
...
for i = 1:size(Condition,2)
    if ~isempty(Kinematics(i).Hgr_obli.mean)
        corridor(Kinematics(i).Hgr_obli.mean,Kinematics(i).Hgr_obli.std,colorR(i,:));
        plot(Kinematics(i).Hgr_obli.mean,'Linestyle','-','Linewidth',2,'Color',colorR(i,:));
    end
end
axis tight; YL=ylim;
YL=setAxisLim(YL,-10,10);
...
for i = 1:size(Condition,2)
    if ~isempty(Kinematics(i).Hgr_rota.mean)
        corridor(Kinematics(i).Hgr_rota.mean,Kinematics(i).Hgr_rota.std,colorR(i,:));
        plot(Kinematics(i).Hgr_rota.mean,'Linestyle','-','Linewidth',2,'Color',colorR(i,:));
    end
end
axis tight; YL=ylim;
YL=setAxisLim(YL,-10,10);
...
for i = 1:size(Condition,2)
   if ~isempty(Kinematics(i).Sgr_tilt.mean)
        corridor(Kinematics(i).Sgr_tilt.mean,Kinematics(i).Sgr_tilt.std,colorR(i,:));
        plot(Kinematics(i).Sgr_tilt.mean,'Linestyle','-','Linewidth',2,'Color',colorR(i,:));
    end
end
axis tight; YL=ylim;
YL=setAxisLim(YL,-10,10);
...
for i = 1:size(Condition,2)
    if ~isempty(Kinematics(i).Sgr_obli.mean)
        corridor(Kinematics(i).Sgr_obli.mean,Kinematics(i).Sgr_obli.std,colorR(i,:));
        plot(Kinematics(i).Sgr_obli.mean,'Linestyle','-','Linewidth',2,'Color',colorR(i,:));
    end
end
axis tight; YL=ylim;
YL=setAxisLim(YL,-10,10);
...
for i = 1:size(Condition,2)
    if ~isempty(Kinematics(i).Sgr_rota.mean)
        corridor(Kinematics(i).Sgr_rota.mean,Kinematics(i).Sgr_rota.std,colorR(i,:));
        plot(Kinematics(i).Sgr_rota.mean,'Linestyle','-','Linewidth',2,'Color',colorR(i,:));
    end
end
axis tight; YL=ylim;
YL=setAxisLim(YL,-10,10);
...
for i = 1:size(Condition,2)
    if ~isempty(Kinematics(i).Rgr_tilt.mean)
        corridor(Kinematics(i).Rgr_tilt.mean,Kinematics(i).Rgr_tilt.std,colorR(i,:));
        plot(Kinematics(i).Rgr_tilt.mean,'Linestyle','-','Linewidth',2,'Color',colorR(i,:));
    end
end
axis tight; YL=ylim;
YL=setAxisLim(YL,-10,10);
...
for i = 1:size(Condition,2)
   if ~isempty(Kinematics(i).Rgr_obli.mean)
        corridor(Kinematics(i).Rgr_obli.mean,Kinematics(i).Rgr_obli.std,colorR(i,:));
        plot(Kinematics(i).Rgr_obli.mean,'Linestyle','-','Linewidth',2,'Color',colorR(i,:));
   end
end
axis tight; YL=ylim;
YL=setAxisLim(YL,-10,10);
...
for i = 1:size(Condition,2)
    if ~isempty(Kinematics(i).Rgr_rota.mean)
        corridor(Kinematics(i).Rgr_rota.mean,Kinematics(i).Rgr_rota.std,colorR(i,:));
        plot(Kinematics(i).Rgr_rota.mean,'Linestyle','-','Linewidth',2,'Color',colorR(i,:));
    end
end
axis tight; YL=ylim;
YL=setAxisLim(YL,-10,10);
...
for i = 1:size(Condition,2)
    if ~isempty(Kinematics(i).Pgr_tilt.mean)
        corridor(Kinematics(i).Pgr_tilt.mean,Kinematics(i).Pgr_tilt.std,colorR(i,:));
        plot(Kinematics(i).Pgr_tilt.mean,'Linestyle','-','Linewidth',2,'Color',colorR(i,:));
    end
end
axis tight; YL=ylim;
YL=setAxisLim(YL,-10,10);
...
for i = 1:size(Condition,2)
    if ~isempty(Kinematics(i).Pgr_obli.mean)
        corridor(Kinematics(i).Pgr_obli.mean,Kinematics(i).Pgr_obli.std,colorR(i,:));
        plot(Kinematics(i).Pgr_obli.mean,'Linestyle','-','Linewidth',2,'Color',colorR(i,:));
    end
end
axis tight; YL=ylim;
YL=setAxisLim(YL,-10,10);
...
for i = 1:size(Condition,2)
    if ~isempty(Kinematics(i).Pgr_rota.mean)
        corridor(Kinematics(i).Pgr_rota.mean,Kinematics(i).Rgr_rota.std,colorR(i,:));
        plot(Kinematics(i).Pgr_rota.mean,'Linestyle','-','Linewidth',2,'Color',colorR(i,:));
    end
end
axis tight; YL=ylim;
YL=setAxisLim(YL,-10,10);
...
%% Events
    for g=1:length(Graph)
        ...
        for i = 1:size(Condition,2)
            corridor(Event(i).p5.mean,Event(i).p5.std,colorR(i,:));         
            plot([Event(i).p5.mean Event(i).p5.mean],[-180 180],'Linestyle','-','Linewidth',2,'Color',colorR(i,:)); %IHS
            plot([Event(i).p2.mean Event(i).p2.mean],[YL(1)-20 YL(1)+(YL(2)-YL(1))/10],'Linewidth',1.5,'Color',colorR(i,:)); %CTO
            plot([Event(i).p4.mean Event(i).p4.mean],[YL(1)-20 YL(1)+(YL(2)-YL(1))/10],'Linewidth',1.5,'Color',colorR(i,:)); %CHS
        end
    end
    g
