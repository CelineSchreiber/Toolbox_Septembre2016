...
for i = 1:length(Session.Gait)
    ...
    if strcmp(Session.Gait(i).condition,Condition.name) && strcmp(Session.Gait(i).upperlimbstrial,'yes')
        ...
        j = j+1;
    elseif strcmp(Session.Gait(i).condition,Condition.name) && strcmp(Session.Gait(i).upperlimbstrial,'no')
        Condition.UpperLimbs(j).Rkinematics = [];
        Condition.UpperLimbs(j).Lkinematics = [];
        j=j+1;
    end
