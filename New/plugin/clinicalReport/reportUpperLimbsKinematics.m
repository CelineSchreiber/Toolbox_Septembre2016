...
%         corridor(inorm.mean,inorm.std,[0.5 0.5 0.5]);
        Rkinematics = eval(['Condition.All.RkinematicsUL.',names{igraph}]);
        ...
        Lkinematics = eval(['Condition.All.LkinematicsUL.',names{igraph}]);
...
%         corridor(inorm.mean,inorm.std,[0.5 0.5 0.5]);
        for i = 1:size(Condition,2)
            Rkinematics(i) = eval(['Condition(i).All.RkinematicsUL.',names{igraph},'']);
