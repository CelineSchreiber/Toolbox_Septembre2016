...
if ~isempty(Rkinetics(1).PowerZ4)
    plot(Rkinetics(1).PowerZ4,'Linestyle','-','Linewidth',2,'Color',colorR(cond,:));
end
if ~isempty(Lkinetics(1).PowerZ4)
    plot(Lkinetics(1).PowerZ4,'Linestyle','-','Linewidth',2,'Color',colorL(cond,:));
end
axis tight;
YL = ylim;
YL = setAxisLim(YL,-10,10);
...
if ~isempty(Rkinetics(1).PowerZ3)
    plot(Rkinetics(1).PowerZ3,'Linestyle','-','Linewidth',2,'Color',colorR(cond,:));
end
if ~isempty(Lkinetics(1).PowerZ3)
    plot(Lkinetics(1).PowerZ3,'Linestyle','-','Linewidth',2,'Color',colorL(cond,:));
end
axis tight;
YL = ylim;
YL = setAxisLim(YL,-10,10);
...
if ~isempty(Rkinetics(1).PowerZ2)
    plot(Rkinetics(1).PowerZ2,'Linestyle','-','Linewidth',2,'Color',colorR(cond,:));
end
if ~isempty(Lkinetics(1).PowerZ2)
    plot(Lkinetics(1).PowerZ2,'Linestyle','-','Linewidth',2,'Color',colorL(cond,:));
end
axis tight;
YL = ylim;
YL = setAxisLim(YL,-10,10);
