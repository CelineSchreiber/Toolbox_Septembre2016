...
if size(Condition,2) == 1
    ...
    plot(1:100,zeros(100,1),'Linestyle','-','Linewidth',0.5,'Color','black');
    corridor(Norm.Kinetics.PowerZ4.mean,Norm.Kinetics.PowerZ4.std,[0.5 0.5 0.5]);
    if ~isempty(Rkinetics(i).PowerZ4.mean)
        corridor(Rkinetics(i).PowerZ4.mean,Rkinetics(i).PowerZ4.std,colorR(i,:));
        plot(Rkinetics(i).PowerZ4.mean,'Linestyle','-','Linewidth',2,'Color',colorR(i,:));
    end
    if ~isempty(Lkinetics(i).PowerZ4.mean)
        corridor(Lkinetics(i).PowerZ4.mean,Lkinetics(i).PowerZ4.std,colorL(i,:));
        plot(Lkinetics(i).PowerZ4.mean,'Linestyle','-','Linewidth',2,'Color',colorL(i,:));
    end
    axis tight;
    YL = ylim;
    ...
    xlabel('Gait cycle (%)','FontSize',8,'HorizontalAlignment','center','VerticalAlignment','Middle'); ylabel('Power (adimensioned)','FontSize',8,'HorizontalAlignment','center','VerticalAlignment','Middle'); 
    plot(1:100,zeros(100,1),'Linestyle','-','Linewidth',0.5,'Color','black');
    corridor(Norm.Kinetics.PowerZ3.mean,Norm.Kinetics.PowerZ3.std,[0.5 0.5 0.5]);
    if ~isempty(Rkinetics(i).PowerZ3.mean)
        corridor(Rkinetics(i).PowerZ3.mean,-Rkinetics(i).PowerZ3.std,colorR(i,:));
        plot(Rkinetics(i).PowerZ3.mean,'Linestyle','-','Linewidth',2,'Color',colorR(i,:));
    end
    if ~isempty(Lkinetics(i).PowerZ3.mean)
        corridor(Lkinetics(i).PowerZ3.mean,Lkinetics(i).PowerZ3.std,colorL(i,:));
        plot(Lkinetics(i).PowerZ3.mean,'Linestyle','-','Linewidth',2,'Color',colorL(i,:));
    end
    axis tight;
    YL = ylim;
    YL = setAxisLim(YL,-0.3,0.3);
    ...
    xlabel('Gait cycle (%)','FontSize',8,'HorizontalAlignment','center','VerticalAlignment','Middle'); ylabel('Power (adimensioned)','FontSize',8,'HorizontalAlignment','center','VerticalAlignment','Middle'); 
    plot(1:100,zeros(100,1),'Linestyle','-','Linewidth',0.5,'Color','black');
    corridor(Norm.Kinetics.PowerZ2.mean,Norm.Kinetics.PowerZ2.std,[0.5 0.5 0.5]);
    if ~isempty(Rkinetics(i).PowerZ2.mean)
        corridor(Rkinetics(i).PowerZ2.mean,Rkinetics(i).PowerZ2.std,colorR(i,:));
        plot(Rkinetics(i).PowerZ2.mean,'Linestyle','-','Linewidth',2,'Color',colorR(i,:));
    end
    if ~isempty(Lkinetics(i).PowerZ2.mean)
        corridor(Lkinetics(i).PowerZ2.mean,Lkinetics(i).PowerZ2.std,colorL(i,:));
        plot(Lkinetics(i).PowerZ2.mean,'Linestyle','-','Linewidth',2,'Color',colorL(i,:));
    end
    axis tight;
    YL = ylim;
